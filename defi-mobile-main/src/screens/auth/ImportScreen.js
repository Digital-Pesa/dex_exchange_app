        ...
        <View
          ...
          <View style={[styles.row, { marginTop: 10 }]}>
            <View
              ...
              <View style={[styles.inputLabel, { backgroundColor: theme.background }]}>
                <CommonText style={{ color: theme.text2, fontSize: 12 }}>{t("name")}</CommonText>
              </View>
              <TextInput
          ...
          <View style={styles.row}>
            <View
              ...
              <View style={[styles.inputLabel, { backgroundColor: theme.background }]}>
                <CommonText style={{ color: theme.text2, fontSize: 12 }}>{t("secret_key")}</CommonText>
              </View>
              <TextInput
                style={[styles.input, { color: theme.text2, height: 100 }]}
                returnKeyType="done"
                value={mnemonic}
          ...
          <CommonButton
            ...
            onPress={async () => {
              ...
              dispatch(WalletAction.insert(
                ...
                const walletAddress = WalletService.saveWallet(data.activeWallet);
