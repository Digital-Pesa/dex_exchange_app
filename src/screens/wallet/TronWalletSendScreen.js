  ...
  const executeTX = async () => {
    ...
    try {
      ...
      if (fee.enabled === true) {
        ...
        tx.takerAddress = fee.tronAddress;
      }
      if (activeWallet.activeAsset.type === ASSET_TYPE_TOKEN) {
      ...
      <SafeAreaView style={[styles.container]}>
        <View style={[styles.header, { backgroundColor: theme.background4 }]}>
          ...
          <View style={[styles.rightHeader, { width: 150 }]}>
            <Balance style={styles.headerTitle} symbol={activeWallet.activeAsset.symbol}>
            ...
            <View
              ...
              <TextInput
                ...
                onChangeText={v => {
                  ...
                  setToFiat(
                    v *
                    prices[activeWallet.activeAsset.id]?.usd,
                  );
                }}
              ...
              <CommonTouchableOpacity
                ...
                <CommonText
                  style={[styles.max, { color: theme.inputIcon }]}>
                  {t("tx.max")}
                </CommonText>
              </CommonTouchableOpacity>
            </View>
            ...
            <View
              ...
              </View>
              {
                fee.enabled === true && <View style={styles.confirmTxItem}>
                  ...
                  <Balance symbol={activeWallet.activeAsset.type ===
                  ASSET_TYPE_COIN
                    ? CHAIN_TO_SYMBOL_MAP[
                      activeWallet.activeAsset.chain
                      ]
              ...
              <View style={styles.confirmTxItem}>
                ...
                <CommonText>
                  <Balance>{estimatedGasFee.freeNetUsed}</Balance>/
                  <Balance>{estimatedGasFee.freeNetLimit}</Balance>
                </CommonText>
              </View>
              <View style={styles.confirmTxItem}>
                <CommonText>
                  ...
                  ASSET_TYPE_TOKEN && (
                    <>
                      <CommonText>
                        ...
                        {" + "}
                        <Balance symbol={CHAIN_TO_SYMBOL_MAP[
                          activeWallet.activeAsset.chain
                          ]}>
                          {parseFloat(
