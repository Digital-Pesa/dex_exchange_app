      ...
      <CommonTouchableOpacity
        ...
        <View style={styles.itemAmount}>
          <CommonText
            ...
            {item.isSender ? "-" : "+"}
            <Balance
              style={{ color: item.isSender ? "#f33360" : "#24a86f" }}
      ...
      <SafeAreaView
        ...
        <View style={[styles.header, { backgroundColor: theme.background2 }]}>
          ...
          <View style={[styles.rightHeader, { flex: 1 }]}>
            <Price style={{ fontWeight: "bold" }}>{prices[activeWallet.activeAsset.id]?.usd}</Price>
          </View>
        </View>
        <View
          style={[
          ...
          <Balance style={[styles.balanceText, { color: theme.text2 }]} symbol={activeWallet.activeAsset.symbol}>
