                ...
                showsVerticalScrollIndicator={false}>
                  ...
                  <View style={styles.item}>
                      ...
                      <CommonTouchableOpacity
                        onPress={async () => {
                            await Linking.openURL(
                              applicationProperties.endpoints.twitter,
                            );
                        }}
                        style={[
                            styles.row,
                      ...
                      <CommonTouchableOpacity
                        onPress={async () => {
                            await Linking.openURL(
                              applicationProperties.endpoints.telegram,
                            );
                        }}
                        style={[
                            styles.row,
                      ...
                      <CommonTouchableOpacity
                        onPress={async () => {
                            await Linking.openURL(
                              applicationProperties.endpoints.facebook,
                            );
                        }}
                        style={[
                            styles.row,
                      ...
                      <CommonTouchableOpacity
                        onPress={async () => {
                            await Linking.openURL(
                              applicationProperties.endpoints.reddit,
                            );
                        }}
                        style={[
                            styles.row,
                      ...
                      <CommonTouchableOpacity
                        onPress={async () => {
                            await Linking.openURL(
                              applicationProperties.endpoints.discord,
                            );
                        }}
                        style={[
                            styles.row,
