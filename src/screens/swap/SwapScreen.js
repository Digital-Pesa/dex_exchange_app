...
import { calcFee, formatCoins, formatNoComma, toEth, toWei } from "@src/utils/CurrencyUtil";
        ...
        <ScrollView
          ...
          <View style={styles.content}>
            <View style={styles.segmentContainer}>
              {
                activeWallet.ethChain === true && <CommonTouchableOpacity
                  onPress={() => {
                    onChangePlatform("ETH");
                    setPlatform("ETH");
                  }}
                  style={[styles.segmentItem, platform === "ETH" ? {
                    backgroundColor: theme.button,
                    borderRadius: 10,
                  } : {}]}>
                  <CommonText style={{ color: platform === "ETH" ? theme.text : theme.subText }}>ERC20</CommonText>
                </CommonTouchableOpacity>
              }
              {
                activeWallet.bscChain === true &&
                <CommonTouchableOpacity
                  onPress={() => {
                    onChangePlatform("BSC");
                    setPlatform("BSC");
                  }}
                  style={[styles.segmentItem, platform === "BSC" ? {
                    backgroundColor: theme.button,
                    borderRadius: 10,
                  } : {}]}>
                  <CommonText style={{ color: platform === "BSC" ? theme.text : theme.subText }}>BEP20</CommonText>
                </CommonTouchableOpacity>
              }
              {
                activeWallet.polygonChain === true && <CommonTouchableOpacity
                  onPress={() => {
                    onChangePlatform("POLYGON");
                    setPlatform("POLYGON");
                  }}
                  style={[styles.segmentItem, platform === "POLYGON" ? {
                    backgroundColor: theme.button,
                    borderRadius: 10,
                  } : {}]}>
                  <CommonText style={{ color: platform === "POLYGON" ? theme.text : theme.subText }}>POLYGON</CommonText>
                </CommonTouchableOpacity>
              }
            ...
            <View
              ...
              {quote &&
                <Balance style={{ color: theme.text2 }} symbol={toToken.symbol}>
                  {quote.price}
                </Balance>
              }
